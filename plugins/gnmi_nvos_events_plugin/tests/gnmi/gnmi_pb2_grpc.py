...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in gnmi/gnmi_pb2_grpc.py depends on'
...
class gNMI(object):
    ...
    def Capabilities(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gnmi.gNMI/Capabilities',
            gnmi_dot_gnmi__pb2.CapabilityRequest.SerializeToString,
            gnmi_dot_gnmi__pb2.CapabilityResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gnmi.gNMI/Get',
            gnmi_dot_gnmi__pb2.GetRequest.SerializeToString,
            gnmi_dot_gnmi__pb2.GetResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Set(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gnmi.gNMI/Set',
            gnmi_dot_gnmi__pb2.SetRequest.SerializeToString,
            gnmi_dot_gnmi__pb2.SetResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Subscribe(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/gnmi.gNMI/Subscribe',
            gnmi_dot_gnmi__pb2.SubscribeRequest.SerializeToString,
            gnmi_dot_gnmi__pb2.SubscribeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
