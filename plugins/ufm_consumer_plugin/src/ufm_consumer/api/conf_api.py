...
class UFMHelloWorldPluginConfigurationsAPI(BaseAPIApplication):
    ...
    def __init__(self):
        ...
        # for debugging
        # self.conf_schema_path = "plugins/ufm_consumer_plugin/src/ufm_consumer/schemas/set_conf.schema.json"

        # for production with docker
        self.conf_schema_path = "ufm_consumer_plugin/src/ufm_consumer/schemas/set_conf.schema.json"
