...
class IsolationMgr:
    ...
    # Temporary wrap into nested class and fully duplicate members initialisation
    class PDRAlgorithm:
        """
    ...
    def main_flow(self):
        ...
        pdr_alg = IsolationMgr.PDRAlgorithm(self.ufm_client, self.exclude_list, self.logger)
        while(True):
            try:
                t_begin = time.time()
